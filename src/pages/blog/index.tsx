...
export function BlogPage() {
  ...
  const [type, setType] = useState(false); // by default - not list posts
                        ...
                        <div className="blog__share">
                          <button className="btn-share">
                            ...
                            <ul className="social-icons">
                              <li>
                                <a
                                  href={`https://twitter.com/intent/tweet?text=Olha isso que interessantet no blog do @kaiogomes_._%0d%0a%0d%0a${value.title}&url=http://kgsa.cf/blog/1`}
                                  rel="noreferrer"
                                  target="_blank"
                                >
                                  <svg
                              ...
                              <li>
                                <a
                                  href={`whatsapp://send?text=Olha isso que interessantet no blog do @kaiogomes_._%0d%0a%0d%0a${value.title}&url=http://kgsa.cf/blog/1`}
                                  rel="noreferrer"
                              ...
                              <li>
                                <a
                                  href={`https://www.linkedin.com/shareArticle?mini=true&url=http://kgsa.cf/blog/1&title=tge&summary=test&source=kgsa.cf`}
                                  rel="noreferrer"
                                  target="_blank"
                                >
                                  <svg
              ...
              return (
                <div className="body__card" key={key}>
                  <div className="body__header">
                    <p>Publicado algum dia - "em breve função para puxar informações do dia/data serão criadas"</p>
                  </div>
                  <br></br>
                  ...
                  <div className="body__image">
                    <center><img src={result.image} alt={result.title}/></center>
                  </div>
                </div>
              );
            })}
